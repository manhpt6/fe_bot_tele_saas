...
import { Plus, Edit2, Trash2, Package, X, Search, Eye, Tag, Settings, Box, Image as ImageIcon, PlusCircle, MinusCircle, Bot, Sparkles, FolderTree, RefreshCw, Copy, Check } from 'lucide-react';
